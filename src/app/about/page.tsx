      ...
      <div className="max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-10 relative">
          ...
          <p className="text-xl text-foreground/70 max-w-3xl mx-auto leading-relaxed">
            Canva School is a skills-development initiative where ten selected youth participants undergo structured workshops to master graphic design. Throughout the program, students engage in hands-on immersion by producing weekly design materials for actual SK 177 initiatives. This practical application ensures that by the end of the training, every participant has developed a professional portfolio consisting of their modular outputs and real-world project contributions.
          </p>
          ...
          <div className="space-y-8">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 bg-surface dark:bg-white/5 p-4 rounded-2xl shadow-sm border border-foreground/10">
                ...
                <span className="font-semibold text-lg text-foreground/90">Build your portfolio</span>
              </li>
              <li className="flex items-center gap-3 bg-surface dark:bg-white/5 p-4 rounded-2xl shadow-sm border border-foreground/10">
                <span className="p-2 rounded-xl bg-red-light dark:bg-red-primary/20 text-red-dark dark:text-red-light"><Award className="w-5 h-5" /></span>
                <span className="font-semibold text-lg text-foreground/90">Receive a Certificate of Completion</span>
              </li>
              <li className="flex items-center gap-3 bg-surface dark:bg-white/5 p-4 rounded-2xl shadow-sm border border-foreground/10">
